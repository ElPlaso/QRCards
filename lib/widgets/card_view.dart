                    ...
                    Column(
                        ...
                        children: [
                          ...
                          Padding(
                              padding:
                                  const EdgeInsets.fromLTRB(0, 2.5, 0, 2.5),
                              child: Text('Cellphone: ${card.cellphone}',
                                  style: const TextStyle(
                                      color: Color.fromARGB(203, 203, 203, 255),
                                      fontSize: 12))),
                          Padding(
                              padding:
                                  const EdgeInsets.fromLTRB(0, 2.5, 0, 2.5),
                              child: Text('Website: ${card.website}',
                                  style: const TextStyle(
                                      color: Color.fromARGB(203, 203, 203, 255),
                                      fontSize: 12))),
                        ]),
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          Padding(
                              padding:
                                  const EdgeInsets.fromLTRB(0, 2.5, 0, 2.5),
                              child: Text('Phone: ${card.companyphone}',
                                  style: const TextStyle(
                                      color: Color.fromARGB(203, 203, 203, 255),
                                      fontStyle: FontStyle.italic,
                                      fontSize: 12))),
